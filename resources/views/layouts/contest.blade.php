...
<html>
    ...
    <body>
        ...
        <main>
            <menu>
                <menuitem>
                    <a href="{!! $major == "index" && $subMajor == "index" ? $current : route( "contest.show" ) !!}">
                        主頁
                    </a>
                </menuitem>
                <details open>
                    <summary>參賽者<i></i></summary>
                    <menuitem>
                        <a href="{!! $major == "player" && $subMajor == "index" ? $current : route( "contest.player.index" ) !!}">
                            參賽者列表
                        </a>
                    </menuitem>
                    <menuitem>
                        <a href="{!! $major == "player" && $subMajor == "create" ? $current : route( "contest.player.create" ) !!}">
                            新增參賽者
                        </a>
                    </menuitem>
                </details>
